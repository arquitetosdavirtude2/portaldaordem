    ...
    return (
        <div className="min-h-screen bg-masonic-blue text-gray-100 font-serif relative overflow-hidden selection:bg-masonic-gold selection:text-masonic-blue">
            ...
            <div className="max-w-7xl mx-auto p-8 relative z-10">
                ...
                <div className={`bg-black/30 backdrop-blur-xl rounded-2xl p-6 border mb-8 ${editingId ? 'border-masonic-gold/50 shadow-[0_0_30px_rgba(212,175,55,0.1)]' : 'border-white/10'} transition-all duration-300`}>
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-black/40 text-masonic-gold uppercase text-[10px] tracking-[0.2em] border-b border-white/5">
                                    ...
                                    <th className="p-4 font-bold whitespace-nowrap text-center">Membros</th>
                            ...
                            <tbody className="divide-y divide-white/5">
                                {lojas.map(l => (
                                    <tr key={l.id} className="transition-colors group hover:bg-white/5">
                                        ...
                                        <td className="p-4 text-xs text-gray-400 w-full">
                                            {l.endereco || '-'}
                                        </td>
