                                    ...
                                    <div className="px-4 py-3 flex items-start gap-3">
                                        ...
                                        <div className="flex items-center gap-1 shrink-0">
                                            ...
                                            <button
                                                ...
                                                disabled={idx === 0}
                                                className="p-1.5 bg-white/[0.03] hover:bg-white/[0.06] border border-transparent rounded-lg cursor-pointer transition-all disabled:opacity-20 disabled:cursor-not-allowed"
                                            ...
                                            <button
                                                ...
                                                className="p-1.5 bg-white/[0.03] hover:bg-red-500/10 border border-transparent hover:border-red-500/20 rounded-lg cursor-pointer transition-all"
                                                title="Excluir"
                                            >
                                                <span className="text-xs opacity-50 group-hover:opacity-100">🗑</span>
                                            </button>
