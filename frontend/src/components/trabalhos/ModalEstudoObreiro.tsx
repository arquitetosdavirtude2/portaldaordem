...
export default function ModalEstudoObreiro({ conteudo, pessoaId, onClose, onSuccess }: ModalEstudoObreiroProps) {
    ...
    return (
        <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 lg:p-8">
            ...
            <div className="w-full max-w-4xl lg:max-h-[90vh] flex flex-col relative z-10 overflow-hidden shadow-2xl rounded-2xl bg-[#050505] border border-white/5 animate-fade-in-up">
                ...
                <div className="flex-1 overflow-y-auto p-6 lg:p-12 relative hidden-scrollbar flex flex-col">
                    ...
                    <div className="flex flex-col items-center text-center mb-10 mt-4 relative z-20 shrink-0">
                        <span className="text-[9px] uppercase tracking-[0.25em] text-yellow-500/70 font-bold mb-4">
                            Grau {conteudo.grau} • {conteudo.tipo}
                        </span>
                        
                        <h1 className="font-serif text-[clamp(1.8rem,2.5vw,2.5rem)] text-[rgba(248,248,252,0.9)] font-light leading-[1.1] tracking-[0.01em] mb-4">
                            {conteudo.titulo}
                        </h1>

                        {conteudo.descricao_jornada && (
                            <p className="font-serif text-[clamp(0.95rem,1vw,1.05rem)] text-white/50 leading-[1.7] font-normal tracking-[0.01em] max-w-2xl mx-auto">
                                {conteudo.descricao_jornada}
                            </p>
                        )}
                    </div>
