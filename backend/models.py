...
class Transacao(Base):
    ...
    recorrencia = Column(String(50), nullable=True, default="nenhuma") # 'nenhuma', 'mensal', 'anual', 'parcelado'
    grupo_recorrencia = Column(String(50), nullable=True) # UUID para agrupar recorrências/parcelas
