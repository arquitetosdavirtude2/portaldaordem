...
try:
    # Attempting to connect as root with no password, typical for XAMPP/WAMP
    engine = sqlalchemy.create_engine('mysql+pymysql://root:@localhost/portald3_gomb?charset=utf8mb4')
